...
Public Class rptPhieuXuatKho
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyKinhDoanh.rptPhieuXuatKho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPhieuXuatKho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPhieuXuatKho = New rptPhieuXuatKho
        rpt.Site = Me.Site
        Return rpt
    End Function
